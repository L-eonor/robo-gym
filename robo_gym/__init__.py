...
register(
    id='GripperMoveFixUR5Sim-v0',
    entry_point='robo_gym.envs:GripperMoveFixUR5Sim',
    max_episode_steps=500
)

register(
    id='GripperMoveFixUR5Sim_v2-v0',
    entry_point='robo_gym.envs:GripperMoveFixUR5Sim_v2',
    max_episode_steps=500
)

register(
    id='GripperMoveFixUR5Sim_v3-v0',
    entry_point='robo_gym.envs:GripperMoveFixUR5Sim_v3',
    max_episode_steps=500
)

register(
    id='GripperMoveFixUR5Sim_v4-v0',
    entry_point='robo_gym.envs:GripperMoveFixUR5Sim_v4',
    max_episode_steps=500
)

register(
    id='GripperMoveFixUR5Sim_v5-v0',
    entry_point='robo_gym.envs:GripperMoveFixUR5Sim_v5',
    max_episode_steps=500
)

register(
    id='GripperMoveFixUR5Sim_v6-v0',
    entry_point='robo_gym.envs:GripperMoveFixUR5Sim_v6',
