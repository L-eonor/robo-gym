...
class UR5RobotiqEnv(gym.Env):
    ...
    def _get_observation_space_with_cubes(self, number_of_objs):
        ...
        max_observation = np.concatenate(( max_gripper_pose, max_gripper_to_obj_pose, max_n_obj_pos, max_overlay, max_gripper_state, max_grasping))
        min_observation = np.concatenate(( min_gripper_pose, min_gripper_to_obj_pose, min_n_obj_pos, min_overlay, min_gripper_state, min_grasping))
    ...
    def _get_action_space(self):
        ...
        action_max=np.concatenate(( max_gripper_pose, max_gripper_state, max_gripper_angle))
        action_min=np.concatenate(( min_gripper_pose, min_gripper_state, min_gripper_angle))
    ...
    def _get_obs(self):
        ...
        overlay = 0
        obs=np.concatenate((obs, [overlay], [is_closed], [is_grasping]))
        return obs
...
class GripperReachGraspInfoUR5_v2(UR5RobotiqEnv):
...
class GripperReachGraspInfoUR5Sim_v2(GripperReachGraspInfoUR5_v2, Simulation):
    ...
    def __init__(self, ip=None, lower_bound_port=None, upper_bound_port=None, gui=False, **kwargs):
        ...
        GripperReachGraspInfoUR5_v2.__init__(self, rs_address=self.robot_server_ip, max_episode_steps=1000, robotiq=85, **kwargs)