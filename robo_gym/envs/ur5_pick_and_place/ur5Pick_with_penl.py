...
class UR5RobotiqEnv(gym.Env):
    ...
    def _get_observation_space_with_cubes(self, number_of_objs):
        ...
        max_observation = np.concatenate(( max_gripper_pose, max_gripper_to_obj_pose, max_n_obj_pos, max_gripper_state, max_grasping))
        min_observation = np.concatenate(( min_gripper_pose, min_gripper_to_obj_pose, min_n_obj_pos, min_gripper_state, min_grasping))
...
class GripperPickUR5(UR5RobotiqEnv):
...
class GripperPickPenUR5Sim(GripperPickUR5, Simulation):
    ...
    def __init__(self, ip=None, lower_bound_port=None, upper_bound_port=None, gui=False, **kwargs):
        ...
        GripperPickUR5.__init__(self, rs_address=self.robot_server_ip, max_episode_steps=1000, robotiq=85, **kwargs)