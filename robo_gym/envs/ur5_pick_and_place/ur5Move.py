...
class GripperMoveUR5(UR5RobotiqEnv):
...
class GripperMoveUR5Sim(GripperMoveUR5, Simulation):
    ...
    def __init__(self, ip=None, lower_bound_port=None, upper_bound_port=None, gui=False, **kwargs):
        ...
        GripperMoveUR5.__init__(self, rs_address=self.robot_server_ip, max_episode_steps=1000, robotiq=85, **kwargs)